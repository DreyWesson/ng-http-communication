...
/* harmony import */ var _services_logger_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./services/logger.service */ "./src/app/services/logger.service.ts");
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _services_http_cache_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/http-cache.service */ "./src/app/services/http-cache.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CacheInterceptor = /** @class */ (function () {
    ...
    CacheInterceptor = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_services_http_cache_service__WEBPACK_IMPORTED_MODULE_4__["HttpCacheService"]])
    ], CacheInterceptor);
...
/* harmony import */ var _core_add_header_interceptor__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../core/add-header.interceptor */ "./src/app/core/add-header.interceptor.ts");
/* harmony import */ var _core_log_response_interceptor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../core/log-response.interceptor */ "./src/app/core/log-response.interceptor.ts");
/* harmony import */ var _core_cache_interceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../core/cache.interceptor */ "./src/app/core/cache.interceptor.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    CoreModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"], useClass: _core_add_header_interceptor__WEBPACK_IMPORTED_MODULE_7__["AddHeaderInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"], useClass: _core_log_response_interceptor__WEBPACK_IMPORTED_MODULE_8__["LogResponseInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"], useClass: _core_cache_interceptor__WEBPACK_IMPORTED_MODULE_9__["CacheInterceptor"], multi: true }
            ]
        }),
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.handleHttpError = function (error) {
        ...
        dataError.friendlyMessage = 'Unsurprisingly an error occurred, bruh';
...
var LogResponseInterceptor = /** @class */ (function () {
    ...
    LogResponseInterceptor.prototype.intercept = function (req, next) {
        console.log("LogResponse Transmission intercepto @ " + req.url);
        // tslint:disable-next-line: prefer-const
        return next.handle(req)
...
/* harmony import */ var app_services_logger_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/services/logger.service */ "./src/app/services/logger.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(dataService, title, route, loggerService) {
        this.dataService = dataService;
        this.title = title;
        this.route = route;
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.title.setTitle("Wesson Tracker " + _angular_core__WEBPACK_IMPORTED_MODULE_0__["VERSION"].full);
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [app_core_data_service__WEBPACK_IMPORTED_MODULE_3__["DataService"],
            ...
            app_services_logger_service__WEBPACK_IMPORTED_MODULE_5__["LoggerService"]])
    ], DashboardComponent);
...
var EditBookComponent = /** @class */ (function () {
    ...
    EditBookComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getBookById(bookID)
            .subscribe(function (data) { return _this.selectedBook = data; }, function (error) { return console.log("This is an error"); }, function () { return console.log("This is complete"); });
...
module.exports = __webpack_require__(/*! /Users/dreyWesson/Desktop/macBrain/atoms/angular-services/booktrackers/src/main.ts */"./src/main.ts");
